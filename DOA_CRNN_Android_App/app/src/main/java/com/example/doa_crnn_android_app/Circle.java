...
public class Circle  extends View
{
    ...
    /*
    public Circle(Context context, float angle1) {
        super(context);
        path1 = new Path();
        path2 = new Path();
        paint = new Paint();
        ...
        this.angle1=angle1-90;
        this.angle2=270-angle1;
...
///////////////////////////////////////////////////////////////////////////////////////////
        ...
        /* float l = 0.6f;/* to make arrow outside of circle , l should be 1.3f*/
        /* float l1 = 0.7f;/* to make arrow outside of circle , l1 should be 1.4f*/

       /* float a = angle1*(float)Math.PI/180;
        // Draw arrow
        path1.moveTo(x+ (float)Math.cos(a) *radius, y + (float)Math.sin(a) * radius);
        path1.lineTo(x+ (float)Math.cos(a+0.2) *radius*l, y + (float)Math.sin(a+0.2) * radius*l);
        path1.lineTo(x+ (float)Math.cos(a) *radius*l1, y + (float)Math.sin(a) * radius*l1);
        path1.lineTo(x+ (float)Math.cos(a-0.2) *radius*l, y + (float)Math.sin(a-0.2) * radius*l);
        path1.lineTo(x+ (float)Math.cos(a) *radius, y + (float)Math.sin(a) * radius);

        canvas.drawPath(path1, paint);*/


     /*   float b = angle2*(float)Math.PI/180;
        // Draw arrow
        path2.moveTo((x+ (float)Math.cos(b) *radius), (y + (float)Math.sin(b) * radius));
        path2.lineTo((x+ (float)Math.cos(b+0.2) *radius*l), (y + (float)Math.sin(b+0.2) * radius*l));
        path2.lineTo((x+ (float)Math.cos(b) *radius*l1), (y + (float)Math.sin(b) * radius*l1));
        path2.lineTo(x+ (float)Math.cos(b-0.2) *radius*l, y + (float)Math.sin(b-0.2) * radius*l);
        path2.lineTo(x+ (float)Math.cos(b) *radius, y + (float)Math.sin(b) * radius);
