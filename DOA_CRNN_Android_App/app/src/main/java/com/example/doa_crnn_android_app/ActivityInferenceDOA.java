...
public class ActivityInferenceDOA {
    ...
    private static final String MODEL_FILE =  "file:///android_asset/frozen_model_2pool_3rnn.pb";//frozen_model_2pool_3rnn.pb  optimized_frozenModel_feb_19.pb
    ...
    public ActivityInferenceDOA(final Context context) {
       ...
       /* try {
            ...
            throw new RuntimeException("Failed to load model from '" + MODEL_FILE + "'", e2);
        }*/
    ...
    public float
        ...
        Log.i(TAG,"Took "+(endTime - startTime) / 1000000 + " ns");
/*
        if (xx==35){
